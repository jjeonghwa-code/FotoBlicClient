...
class PuzzleForm extends Component {
  ...
  setFullname = e => {
    ...
    // this.props.updateFullname(e.target.value);
  };
  ...
  render() {
    ...
    const totalPrice = this.props.sendTotalPrice;
    ...
    let quantity_A4_velika = 0;
    let quantity_A5_mala = 0;

    for (index = 0; index < articles.length; index++) {
      if (articles[index][1] === "14") {
        quantity_A4_velika += articles[index][2];
        articlesArray["A4"] = quantity_A4_velika;
      } else if (articles[index][1] === "15") {
        quantity_A5_mala += articles[index][2];
        articlesArray["A5"] = quantity_A5_mala;
      }
    }
    //////////////////
    return (
            ...
            <div className="yourShopItem">
              ...
              <div className="your_shop_item">
                ...
                {Object.entries(articlesArray).map(([key, value]) => (
                  <p>
                    Naručili ste {value} puzle formata {key}
                  </p>
                ))}
              </div>
            </div>

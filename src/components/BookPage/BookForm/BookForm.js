...
class BookForm extends Component {
  ...
  toggleCheckbox1 = () => {
    // Prosledjivanje state.delivery u Parent komponentu "BookPage"
  ...
  render() {
    ...
    let format;
    if (this.props.format === "23") {
      format = "Book A4 - 20 strana";
    } else if (this.props.format === "24") {
      format = "Book A5 - 10 strana";
    } else if (this.props.format === "25") {
      format = "Book A4 - 5 strana";
    } else {
      format = "Book na akciji";
    }

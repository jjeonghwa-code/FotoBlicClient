...
class CupForm extends Component {
  ...
  toggleCheckbox1 = () => {
    // Prosledjivanje state.delivery u Parent komponentu "Tshirt"
  ...
  render() {
    ...
    if (format_id === "16") {
      ...
      format = "M";
    } else if (format_id === "18") {
      format = "L";
    } else if (format_id === "19") {
      format = "XL";
    } else if (format_id === "20") {
      format = "XXL";
    }
    return (
          ...
          <div className="form_holder_left">
            <div className="yourShopItem">
              ...
              <div className="your_shop_item">
                <p>Proizvod: {this.props.product}</p>
                <p>Format: {format}</p>
                <p>Kolicina: {this.props.quantity}</p>
              </div>
            </div>
            <div className="price">
